...
PCMWaveReader::PCMWaveReader(std::string filename)
{
...
PCMWaveReader::~PCMWaveReader()
{

}

int PCMWaveReader::checkDataFormat(PCMWaveHeader *header)
{
    int error = 0;
...
std::vector<unsigned int> *PCMWaveReader::generateFreqDivs(double frequency)
{
...
PCMWaveHeader *PCMWaveReader::getHeader()
{
    return &header;
}
